...
Reads this experiment's frozen data/rings.json snapshot —
no lake access needed, this is a pure re-aggregation of existing per-asset
annual stats.

Emits data/chronology.json (tiny — a few years x 5 classes).
...
RINGS = os.path.join(HERE, "data", "rings.json")
OUT = os.path.join(HERE, "data", "chronology.json")
